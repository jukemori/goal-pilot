        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              ...
              <span className="text-green-600"> Daily Actions</span>
            </h1>
...
function Step({
  ...
  return (
    <div className="flex gap-4">
      <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-green-600 text-white font-semibold">
        {number}
      </div>
      <div>
