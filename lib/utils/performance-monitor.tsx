      ...
      console.log(`[Performance] ${componentName}:`, {
        ...
        memoryUsage:
          'memory' in performance
            ? `${((performance as typeof performance & { memory: { usedJSHeapSize: number } }).memory.usedJSHeapSize / 1024 / 1024).toFixed(2)}MB`
            : 'N/A',
      })
    }
...
export function PerformanceWidget({
  ...
  return (
    <div className="fixed right-4 bottom-4 z-50 w-72">
      <Card className="border-gray-700 bg-black/90 text-white">
...
export class BundleSizeTracker {
  ...
  getTotalSize() {
    return Array.from(this.bundleSizes.values()).reduce(
