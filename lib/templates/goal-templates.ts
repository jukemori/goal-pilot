export interface GoalTemplate {
  id: string
  category: 'programming' | 'language' | 'fitness' | 'business' | 'creative' | 'academic'
  title: string
  description: string
...
export const GOAL_TEMPLATES: GoalTemplate[] = [
  // Programming Templates
  {
    ...
    description: 'Master HTML, CSS, and JavaScript fundamentals to build modern, responsive websites from scratch',
    ...
    customization_notes: 'Feel free to adjust the time commitment based on your schedule. This template works well for 4-5 days per week. You can modify the title to be more specific (e.g., "Build My First Portfolio Website") and adjust the current level description to match your exact experience.'
  },
  {
    id: 'python-programming',
    category: 'programming',
    title: 'Master Python Programming Fundamentals',
    description: 'Learn Python from basics to building real-world applications including data analysis and automation scripts',
    suggested_current_levels: [
    ...
    customization_notes: 'This template is designed for 4 days per week with focused practice sessions. You can adjust the title to be more specific to your goals (e.g., "Learn Python for Data Analysis" or "Python for Web Development"). The schedule can be modified to fit your availability - many students prefer consistent daily practice or intensive weekend sessions.'
  },
  {
    id: 'react-development',
    category: 'programming',
    title: 'Build Modern Web Apps with React',
    description: 'Master React.js to create dynamic, interactive web applications with modern JavaScript and component-based architecture',
    suggested_current_levels: [
    ...
    customization_notes: 'This intensive template assumes you already know JavaScript basics. You can adjust the time commitment (90min sessions work well for React practice) and modify the title based on your project goals (e.g., "Build an E-commerce App with React"). Consider your JavaScript comfort level when setting your current level.'
  },
  ...
  // Language Templates
  {
    ...
    description: 'Develop practical Spanish speaking skills for travel, work, and everyday conversations with native speakers',
    suggested_current_levels: [
    ...
    customization_notes: 'Daily practice is key for language learning! This template includes 6 days/week for consistency. You can customize the title for specific goals (e.g., "Spanish for Travel to Mexico" or "Business Spanish Conversations"). Adjust your current level to help AI create the right difficulty roadmap for you.'
  },
  {
    id: 'japanese-business',
    category: 'language',
    title: 'Professional Business Japanese',
    description: 'Master Japanese for professional contexts including formal communication, meetings, and business etiquette',
    suggested_current_levels: [
    ...
    customization_notes: 'Business Japanese requires consistent daily practice. This template assumes you have basic Japanese skills already. You can specify your industry in the title (e.g., "Business Japanese for Tech Industry") and adjust your current level to reflect your actual Japanese ability for better AI roadmap generation.'
  },
  ...
  // Fitness Templates
  {
    ...
    description: 'Build a sustainable fitness routine combining cardio, strength training, and healthy lifestyle habits',
    suggested_current_levels: [
    ...
    suggested_target_date_weeks: 12,
    customization_notes: 'This template starts with 3 days per week to build sustainable habits. You can adjust based on your schedule and add more days as you progress. Feel free to customize the title to match your specific fitness goals (e.g., "Get Strong and Lose 20 Pounds" or "Build Athletic Foundation").'
  },
  {
    id: 'marathon-training',
    category: 'fitness',
    title: 'Complete My First Marathon (26.2 Miles)',
    description: 'Systematic 20-week training program to safely build endurance and cross the marathon finish line',
    suggested_current_levels: [
    ...
    suggested_target_date_weeks: 20,
    customization_notes: 'Marathon training requires 5 days per week including long runs on weekends. You can specify a target race in your title (e.g., "Train for Boston Marathon 2024"). Be honest about your current running ability - the AI will create a safe progression plan based on your level.'
  },
  ...
  // Business Templates
  {
    ...
    description: 'Learn comprehensive digital marketing including SEO, social media, paid ads, and analytics to grow businesses online',
    suggested_current_levels: [
    ...
    customization_notes: 'This template includes practical application - you\'ll create real campaigns. You can customize the title for your industry (e.g., "Digital Marketing for E-commerce" or "B2B Digital Marketing Mastery"). The schedule allows for both learning and implementation time.'
  },
  {
    id: 'public-speaking',
    category: 'business',
    title: 'Become a Confident Public Speaker',
    description: 'Overcome speaking anxiety and develop charismatic presentation skills for professional and personal success',
    suggested_current_levels: [
    ...
    customization_notes: 'Public speaking improves with practice! This template includes 4 days per week for regular practice. You can customize the title for specific goals (e.g., "Confident Wedding Speech" or "Professional Presentation Skills"). Be honest about your current comfort level for the best training plan.'
  },
  ...
  // Creative Templates
  {
    ...
    description: 'Learn photography fundamentals, camera techniques, and photo editing to create stunning images',
    suggested_current_levels: [
    ...
    suggested_target_date_weeks: 10,
    customization_notes: 'Photography benefits from regular practice and experimenting with different subjects. This template includes weekend shooting time. You can customize for specific photography interests (e.g., "Portrait Photography Mastery" or "Travel Photography Skills").'
  },
  {
    id: 'music-production',
    category: 'creative',
    title: 'Create and Produce Original Music',
    description: 'Learn music production from recording to mastering using digital audio workstations and modern techniques',
    suggested_current_levels: [
    ...
    suggested_target_date_weeks: 16,
    customization_notes: 'Music production requires longer focused sessions, so this template uses 90-minute blocks. You can customize based on your musical style (e.g., "Electronic Music Production" or "Singer-Songwriter Recording"). The schedule includes weekend time for creative flow.'
  },
  ...
  // Academic Templates
  {
    ...
    description: 'Master data analysis, statistics, machine learning, and Python to solve real-world problems with data',
    suggested_current_levels: [
    ...
    customization_notes: 'Data science requires consistent practice with both theory and hands-on projects. This template uses 90-minute sessions for deep work. You can customize for specific domains (e.g., "Data Science for Healthcare" or "Financial Data Analysis"). Your math/programming background will help AI create the right learning path.'
  }
]
