...
export const ENHANCED_TEMPLATES: Record<string, EnhancedTemplate> = {
  'learn spanish': {
    overview:
      'Master Spanish through immersive practice, structured grammar learning, and cultural immersion to achieve conversational fluency',
    approach:
      'Progressive methodology combining vocabulary acquisition, grammar mastery, listening comprehension, speaking practice, and cultural understanding',
    ...
    prerequisites: [
      'Basic language learning concepts',
      'Dedicated practice time',
      'Access to Spanish media',
    ],
    phases: [
      {
        ...
        weeks: 2,
        description:
          'Establish fundamental Spanish language skills including pronunciation, basic vocabulary, and essential phrases for daily communication',
        skills_to_learn: [
        ...
        learning_objectives: [
          'Pronounce Spanish sounds correctly',
          'Introduce yourself in Spanish',
          'Count and use numbers in context',
          'Recognize common Spanish words',
        ],
        key_concepts: [
          'Spanish phonetics',
          'Gender of nouns',
        ...
        daily_activities: [
          ...
          'Vocabulary flashcards (50 new words/week)',
          'Listen to basic Spanish conversations',
        ...
        milestones: [
          ...
          'Have basic 2-minute conversation',
        ],
      },
      {
        ...
        weeks: 2,
        description:
          'Master fundamental Spanish grammar including present tense verbs, articles, and basic sentence construction',
        skills_to_learn: [
        ...
        learning_objectives: [
          ...
          'Use articles correctly with nouns',
          'Form basic questions and statements',
        ...
        daily_activities: [
          'Conjugation practice exercises',
        ...
        resources: [
          ...
          'Conjugation practice app',
          'Grammar explanation videos',
          'Sentence building exercises',
        ],
        milestones: [
          'Conjugate 20 common verbs',
          'Form 10 different question types',
      ...
      },
      {
        ...
        weeks: 2,
        description:
          'Develop practical conversation skills for common daily situations including shopping, dining, and social interactions',
        skills_to_learn: [
          'Restaurant ordering',
          'Shopping vocabulary',
        ...
        learning_objectives: [
          'Order food in Spanish restaurants',
          'Shop for basic items',
          'Navigate using Spanish directions',
        ...
        milestones: [
          'Complete 5-minute restaurant interaction',
      ...
      },
      {
        ...
        weeks: 2,
        description:
          'Advance to complex grammar including past tenses, subjunctive mood introduction, and sophisticated sentence structures',
        skills_to_learn: [
        ...
        learning_objectives: [
          'Narrate past events accurately',
      ...
      },
      {
        ...
        weeks: 2,
        description:
          'Achieve conversational fluency through advanced grammar, extensive vocabulary, and natural expression patterns',
        skills_to_learn: [
        ...
        learning_objectives: [
          'Engage in hour-long conversations',
        ...
        resources: [
          ...
          'Spanish podcasts and news',
          'Literature excerpts',
          'Debate topic lists',
        ],
        milestones: [
          'Sustain 30-minute conversations',
          'Understand TV shows without subtitles',
      ...
      },
      {
        ...
        weeks: 2,
        description:
          'Refine language skills to near-native level with focus on regional variations, professional communication, and cultural nuances',
        skills_to_learn: [
        ...
        learning_objectives: [
          'Communicate professionally in Spanish',
          'Understand multiple Spanish dialects',
          'Write formal documents',
          'Appreciate cultural humor and references',
        ],
        key_concepts: [
        ...
        milestones: [
          ...
          'Understand multiple dialects',
        ],
      },
    ],
    success_metrics: [
      'Pass DELE B2 level exam',
      'Sustain 1-hour conversations',
      'Read Spanish novels',
      'Write formal emails',
    ],
    common_challenges: [
  ...
  'learn python': {
    overview:
      'Master Python programming from complete beginner to building real-world applications with professional development practices',
    approach:
      'Project-based learning with hands-on coding, theoretical understanding, and practical application development',
    ...
    phases: [
      {
        ...
        weeks: 2,
        description:
          'Establish core Python programming skills including syntax, data types, variables, and basic program flow control',
        skills_to_learn: [
        ...
        daily_activities: [
          'Write 5 small programs daily',
          'Practice syntax exercises',
          'Debug simple errors',
      ...
      },
      {
        ...
        weeks: 2,
        description:
          'Master program control structures including loops, conditionals, and function creation for code organization',
        skills_to_learn: [
          'If/else statements',
          'For and while loops',
        ...
        milestones: [
          'Build text-based adventure game',
          'Create utility function library',
          'Solve 20 coding challenges',
        ],
      },
      {
        ...
        weeks: 2,
        description:
          "Learn to work with Python's built-in data structures and implement basic algorithms for data manipulation",
        skills_to_learn: [
      ...
      },
      {
        ...
        weeks: 2,
        description:
          'Master object-oriented programming concepts including classes, inheritance, and design patterns',
        skills_to_learn: [
        ...
        learning_objectives: [
          ...
          'Implement inheritance structures',
        ...
        milestones: [
          ...
          'Create game with multiple classes',
      ...
      },
      {
        ...
        weeks: 2,
        description:
          'Introduction to web development using Python frameworks and API integration',
        skills_to_learn: [
      ...
      },
      {
        ...
        weeks: 2,
        description:
          'Explore advanced Python concepts including testing, debugging, and deployment practices',
        skills_to_learn: [
...
export function findEnhancedTemplate(
  goalTitle: string,
): EnhancedTemplate | null {
...
export function personalizeTemplate(
  ...
  const timeMultiplier =
    userContext.timeCommitment < 30
      ? 1.5
      : userContext.timeCommitment > 60
        ? 0.8
        : 1
  personalizedTemplate.total_estimated_hours = Math.round(
    template.total_estimated_hours * timeMultiplier,
  )
