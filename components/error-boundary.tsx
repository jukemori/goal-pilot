      ...
      fallback={({ resetError }) => (
        <div className="p-6 border border-blue-200 rounded-lg bg-blue-50 text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <div>
              <h3 className="font-medium text-blue-800 mb-1">Calendar unavailable</h3>
              <p className="text-blue-700 text-sm mb-4">
                We're having trouble loading your calendar. Please try refreshing.
              </p>
              <Button 
                onClick={resetError}
                variant="outline"
      ...
      fallback={({ resetError }) => (
        <div className="p-6 border border-purple-200 rounded-lg bg-purple-50 text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <div>
              <h3 className="font-medium text-purple-800 mb-1">Roadmap loading error</h3>
